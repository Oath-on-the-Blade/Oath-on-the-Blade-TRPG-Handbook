...
先讀取 Handbook repository 的「AI_GM讀取路由.md」控制最小載入，再讀取並遵守「GM規則/README.md」，再依該入口按本次工作階段需要讀取「GM規則/角色卡格式.md」、「GM規則/創角.md」、「GM規則/開局環境.md」、「GM規則/開局檢查.md」、「GM規則/遊戲流程.md」或「GM規則/結算.md」，並按實際需要查閱「遊玩規則/」與「內容庫/」中的相關權威文件。涉及昊國地理、歷史、固定人物、門派、朝廷或江湖社會時，先讀取「世界知識庫/README.md」及其指定的相關世界觀文件；已由本局存檔改變的世界狀態優先於世界知識庫的起始基準。
